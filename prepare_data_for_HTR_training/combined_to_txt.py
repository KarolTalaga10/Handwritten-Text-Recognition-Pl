...
def csv_to_txt(combined_output_file, output_folder):
...
if __name__ == '__main__':
    output_folder_name = "../data/dataset/gt"
    combined_output_file_name = "words.txt"
    csv_to_txt(combined_output_file_name, output_folder_name)
